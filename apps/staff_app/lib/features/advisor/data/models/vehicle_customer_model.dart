...
const List<String> kNissanModels = [
  ...
  'Nissan AD PETROL',
  'Nissan AD DIESEL',
  'Nissan AD EXPERT PETROL',
  'Nissan AD EXPERT DIESEL',
  'Nissan Acty PETROL',
  'Nissan Altima PETROL',
  'Nissan Armada PETROL',
  'Nissan Frontier PETROL',
  'Nissan Kicks PETROL',
...
List<String> modelsForBrand(String brand) {
  return kModelsByBrand[brand] ??
      [
        '$brand Model A PETROL',
        '$brand Model B DIESEL',
        '$brand Model C PETROL',
      ];
}

List<String> get kModelYears => List.generate(20, (i) => '${2029 - i}');

const List<String> kCylinders = [
  '2',
  '3',
  '4',
  '5',
