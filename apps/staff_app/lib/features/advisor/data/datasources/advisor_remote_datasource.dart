...
class AdvisorRemoteDataSource {
  ...
  Future<CheckInResult?> checkInVehicleResult(String bookingId, Map<String, dynamic> data) async =>
      (await _client.post<CheckInResult>(
  ...
  Future<JobCardDetailResponse> getJobCard(String id) async {
    ...
    final detail = result.when(success: (value) => value, failure: (_) => const JobCardDetailResponse());
  ...
  )).when(success: (v) => v, failure: (_) => const InspectionDraftResponse());
  ...
  )).when(success: (l) => l.map((e) => PendingApprovalResponse.fromJson(e)).toList(), failure: (_) => []);
  ...
  Future<List<ReminderResponse>> getReminders() async => (await _client.get<List<dynamic>>(
    ...
    fromJson: (d) => d as List<dynamic>,
  )).when(success: (l) => l.map((e) => ReminderResponse.fromJson(e)).toList(), failure: (_) => []);
  ...
  Future<RepairOrderResponse> createRepairOrder(Map<String, dynamic> data) async =>
      (await _client.post<RepairOrderResponse>(
        ApiEndpoints.repairOrders,
        data: data,
        fromJson: (d) => RepairOrderResponse.fromJson(d),
      )).when(success: (v) => v, failure: (_) => const RepairOrderResponse());

  Future<RepairOrderResponse> createRepairOrderStrict(Map<String, dynamic> data) async =>
      (await _client.post<RepairOrderResponse>(
        ApiEndpoints.repairOrders,
        data: data,
        fromJson: (d) => RepairOrderResponse.fromJson(d),
  ...
  Future<List<CustomerSearchResponse>> searchCustomers(String q) async => (await _client.get<List<dynamic>>(
    ...
    queryParams: {'q': q},
    fromJson: (d) => d as List<dynamic>,
  )).when(success: (l) => l.map((e) => CustomerSearchResponse.fromJson(e)).toList(), failure: (_) => []);

  Future<List<VehicleSearchResponse>> searchVehicles(String q) async => (await _client.get<List<dynamic>>(
    ApiEndpoints.vehicleSearch,
    queryParams: {'q': q},
    fromJson: (d) => d as List<dynamic>,
  )).when(success: (l) => l.map((e) => VehicleSearchResponse.fromJson(e)).toList(), failure: (_) => []);
  ...
  Future<List<AdvisorBookingResponse>> getAssignedBookings() async {
    ...
    return result
        .unwrapOrThrow()
        .map((item) => AdvisorBookingResponse.fromJson(Map<String, dynamic>.from(item as Map)))
        .toList();
  }
  ...
  Future<List<WorkItemResponse>> getWorkItems(String jobCardRef) async => (await _client.get<List<dynamic>>(
    ...
    fromJson: (d) => d as List<dynamic>,
  )).when(success: (l) => l.map((e) => WorkItemResponse.fromJson(e)).toList(), failure: (_) => []);
  ...
  Future<List<AdvisorTechnicianResponse>> getTechnicians() async => (await _client.get<List<dynamic>>(
    ...
    fromJson: (d) => d as List<dynamic>,
  )).when(success: (l) => l.map((e) => AdvisorTechnicianResponse.fromJson(e)).toList(), failure: (_) => []);
  ...
  Future<List<StaffNotificationResponse>> getStaffNotifications() async => (await _client.get<List<dynamic>>(
    ...
    fromJson: (d) => d as List<dynamic>,
  )).when(success: (l) => l.map((e) => StaffNotificationResponse.fromJson(e)).toList(), failure: (_) => []);
  ...
  Future<bool> assignTasks(String jobCardRef, Map<String, dynamic> data) async {
    final r = await _client.post('/advisor/job-cards/$jobCardRef/tasks', data: data);
    return r is Success;
  }

  Future<bool> checkInVehicle(String bookingId, Map<String, dynamic> data) async =>
      await checkInVehicleResult(bookingId, data) != null;

  Future<bool> deliverVehicle(String jobCardRef, Map<String, dynamic> data) async {
    final r = await _client.post('/advisor/job-cards/$jobCardRef/deliver', data: data);
    return r is Success;
  }
}
