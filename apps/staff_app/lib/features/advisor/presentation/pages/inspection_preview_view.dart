                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 8),
                        const Text(
                          'Rating is optional. You can save the job\nwithout rating any items.',
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 12,
                      color: rated > 0 ? AppColors.success : AppColors.text3,
        ...
        children: [
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text(
                jobId.isNotEmpty ? 'Save & Update Job' : 'Save Inspection',
                style: const TextStyle(
                  fontSize: 15,
                  fontWeight: FontWeight.w700,
                ),
