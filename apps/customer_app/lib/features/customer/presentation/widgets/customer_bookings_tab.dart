...
class _FeaturedPackagesCarousel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final packages = [
      ('Full Synthetic Oil Service', 'AED 89', '45 mins', Icons.oil_barrel_rounded, colorScheme.primary),
      ('Brake Disc & Pad Replacement', 'AED 149', '1.5 hrs', Icons.minor_crash_rounded, colorScheme.error),
      ('Air Conditioning Regas', 'AED 59', '30 mins', Icons.ac_unit_rounded, colorScheme.secondary),
    ];
