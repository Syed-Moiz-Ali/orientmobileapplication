  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text(
          'Book Service',
          style: theme.textTheme.labelLarge?.copyWith(fontWeight: FontWeight.w800, color: colorScheme.onPrimary),
        ),
      ),
      body: SafeArea(
          ...
          child: AppResponsivePage(
            ...
            child: Column(
              ...
              children: [
                ...
                _UberSearchPill(onTap: () => context.push(AppRoutes.customerBookService)),
                ...
                const SizedBox(height: 16),
                _PromoCarousel(onTap: () => context.push(AppRoutes.customerBookService)),
                const SizedBox(height: 36),
                ...
                const SizedBox(height: 16),
                _RecommendedServicesList(onBook: () => context.push(AppRoutes.customerBookService)),
                const SizedBox(height: 36),
...
class _PremiumHeader extends StatelessWidget {
  ...
  const _PremiumHeader({required this.firstName, required this.unreadCount, required this.onNotificationTap});
          ...
          child: Stack(
            ...
            children: [
              Container(
                ...
                child: Icon(Icons.notifications_outlined, color: colorScheme.onSurface, size: 22),
              ),
              if (unreadCount > 0)
                Positioned(
                  top: -2,
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.search_rounded, color: colorScheme.primary, size: 22),
          ),
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: textTheme.titleMedium?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.w800),
                ),
                Text(
...
class _BentoQuickActions extends StatelessWidget {
  ...
  const _BentoQuickActions({required this.onBook, required this.onTrack, required this.onGarage, required this.onSos});
...
class _BentoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppCard(
      ...
      elevation: 0,
      color: bgColor,
      borderColor: isPrimary || isDanger ? Colors.transparent : colorScheme.outlineVariant,
      onTap: onTap,
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            title,
            style: textTheme.titleSmall?.copyWith(color: fgColor, fontWeight: FontWeight.w800, height: 1.1),
          ),
        ],
      ),
    );
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(color: colorScheme.primary.withValues(alpha: 0.1), shape: BoxShape.circle),
            child: Icon(Icons.satellite_alt_rounded, color: colorScheme.primary, size: 28),
          ),
          const SizedBox(width: 16),
          Expanded(
            child: Column(
      ...
      child: ListView(
        ...
        children: [
          _PromoCard(
            ...
            imageUrl: 'https://images.unsplash.com/photo-1469285994282-454ceb49e63c?q=80&w=800&auto=format&fit=crop',
            onTap: onTap,
          ),
          const SizedBox(width: 16),
          _PromoCard(
...
class _PromoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppCard(
      ...
      boxShadow: [
        BoxShadow(color: colorScheme.shadow.withValues(alpha: 0.1), blurRadius: 16, offset: const Offset(0, 6)),
      ],
      child: Stack(
        children: [
            ...
            child: Row(
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(Icons.workspace_premium_rounded, color: colorScheme.secondary, size: 20),
                          const SizedBox(width: 8),
                          Text(
                            'ORIENT PLUS',
                            style: textTheme.labelSmall?.copyWith(
                ...
                ElevatedButton(
                  ...
                  child: Text(
                    'Join',
                    style: TextStyle(fontWeight: FontWeight.w800, color: colorScheme.inverseSurface),
                  ),
                ),
              ],
            ),
...
class _GarageShowcase extends StatelessWidget {
  ...
  const _GarageShowcase({required this.vehicles, required this.onAddVehicle, required this.onBookService});
...
class _VehicleCard extends StatelessWidget {
  ...
  const _VehicleCard({required this.vehicle, required this.imageUrl, required this.onBook});
  ...
  Widget build(BuildContext context) {
    ...
    return AppCard(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.add_circle_outline_rounded, size: 36, color: colorScheme.primary),
          const SizedBox(height: 12),
          Text(
            'Add Vehicle',
            style: Theme.of(
              context,
            ).textTheme.labelLarge?.copyWith(color: colorScheme.primary, fontWeight: FontWeight.w800),
          ),
        ],
      ),
    );
      ...
      child: ListView(
        ...
        children: [
          ...
          _ServicePackageCard(
            ...
            price: 'From \$49',
            imageUrl: 'https://images.unsplash.com/photo-1632733711679-529326f6db12?q=80&w=800&auto=format&fit=crop',
            onTap: onBook,
          ),
          const SizedBox(width: 16),
          _ServicePackageCard(
            ...
            price: 'Free',
            imageUrl: 'https://images.unsplash.com/photo-1600661653561-629509216228?q=80&w=800&auto=format&fit=crop',
            onTap: onBook,
          ),
        ],
      ),
...
class _ServicePackageCard extends StatelessWidget {
  ...
  const _ServicePackageCard({required this.title, required this.price, required this.imageUrl, required this.onTap});
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(price, style: textTheme.labelMedium?.copyWith(color: colorScheme.onSurfaceVariant)),
              ],
            ),
          ),
        ],
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ListView(
        ...
        clipBehavior: Clip.none,
        children: const [
          _TipCard(title: '5 signs your brakes need replacing', icon: Icons.car_crash_rounded),
          SizedBox(width: 16),
          _TipCard(title: 'How to prep your car for winter', icon: Icons.ac_unit_rounded),
          SizedBox(width: 16),
          _TipCard(title: 'Understanding tire pressure codes', icon: Icons.tire_repair_rounded),
        ],
      ),
    );
  }
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Center(child: Icon(icon, color: colorScheme.primary, size: 32)),
          ),
          const SizedBox(width: 16),
          Expanded(
            child: Text(
      ...
      child: Column(
        children: [
          for (int i = 0; i < bookings.length; i++) ...[
            _ActivityTile(booking: bookings[i], onTap: () => onTap(bookings[i])),
            if (i < bookings.length - 1) Divider(height: 1, color: colorScheme.outlineVariant),
          ],
        ],
      ),
    );
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(Icons.receipt_long_rounded, color: colorScheme.onSurface, size: 20),
            ),
            const SizedBox(width: 16),
            Expanded(
              child: Column(
...
class _SectionHeadingWithAction extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Text(title, style: textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w900, letterSpacing: -0.5)),
        GestureDetector(
          onTap: onAction,
          child: Text(
            actionText,
            style: textTheme.labelLarge?.copyWith(color: colorScheme.primary, fontWeight: FontWeight.w800),
          ),
        ),
      ],
    );
