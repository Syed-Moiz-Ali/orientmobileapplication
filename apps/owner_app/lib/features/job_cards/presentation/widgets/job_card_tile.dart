...
class _StatusBadge extends StatelessWidget {
  ...
  Color _statusColor(JobCardStatus s) => switch (s) {
    ...
    JobCardStatus.inspected => AppColors.info,
    JobCardStatus.approved => AppColors.success,
    JobCardStatus.workAssigned => AppColors.primary,
  ...
  Color _statusBg(JobCardStatus s) => switch (s) {
    ...
    JobCardStatus.inspected => AppColors.infoBg,
    JobCardStatus.approved => AppColors.successBg,
    JobCardStatus.workAssigned => AppColors.primaryBg,
