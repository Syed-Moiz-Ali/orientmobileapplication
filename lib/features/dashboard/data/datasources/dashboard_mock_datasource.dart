...
class DashboardMockDataSource implements DashboardDataSource {
  ...
  List<TopSalesCategory> get topSalesCategories => const [
    ...
    TopSalesCategory(title: 'Brand / Model Wise', items: [
    ...
    TopSalesCategory(title: 'Advisor Wise', items: [
    ...
    TopSalesCategory(title: 'Profit Wise', items: [
    ...
    TopSalesCategory(title: 'Sales Value Wise', items: [
    ...
    TopSalesCategory(title: 'Spare Parts Profit Wise', items: [
    ...
    TopSalesCategory(title: 'Labour Profit Wise', items: [
    ...
    TopSalesCategory(title: 'Department Wise', items: [
