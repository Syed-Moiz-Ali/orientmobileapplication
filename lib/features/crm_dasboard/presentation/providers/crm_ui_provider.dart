...
class CrmUiNotifier extends Notifier<CrmUiState> {
  @override
  CrmUiState build() => const CrmUiState(
    selectedIndex: 0,
    period: 'Today',
  ...
  void toggleAutoAssign() {
    state = state.copyWith(autoAssign: !state.autoAssign);
  }
  ...
  List<ConversationEntity> get conversations => const [
    ...
    ConversationEntity(
      ...
      time: '12:15',
      channel: 'Google Ads',
      channelColor: AppColors.amber500,
      unread: 1,
      status: 'ACTIVE',
    ),
    ConversationEntity(
      ...
      time: 'Yesterday',
      channel: 'Website',
      channelColor: AppColors.cyanBright,
      unread: 0,
      status: 'UNANSWERED',
    ),
    ConversationEntity(
      ...
      time: '2 days ago',
      channel: 'SMS',
      channelColor: AppColors.purpleAccent,
      unread: 0,
      status: 'LOST',
    ),
  ];
