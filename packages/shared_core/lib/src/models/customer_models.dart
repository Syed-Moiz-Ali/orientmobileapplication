class CustomerProfileResponse {
  ...
  factory CustomerProfileResponse.fromJson(Map<String, dynamic> j) =>
...
class ActiveServiceResponse {
  ...
  final List<ServiceStageDto> stages;
  const ActiveServiceResponse({
  ...
  factory ActiveServiceResponse.fromJson(Map<String, dynamic> j) =>
      ActiveServiceResponse(
        ...
        stages:
            (j['stages'] as List<dynamic>?)
                ?.map((e) => ServiceStageDto.fromJson(e))
                .toList() ??
            [],
      );
}
...
class ServiceTypeResponse {
  ...
  factory ServiceTypeResponse.fromJson(Map<String, dynamic> j) =>
      ServiceTypeResponse(
        id: (j['id'] ?? '').toString(),
        name: j['name'] as String? ?? '',
