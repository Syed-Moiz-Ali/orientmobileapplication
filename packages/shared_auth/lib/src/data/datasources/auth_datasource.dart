...
abstract class AuthDatasource {
  ...
  Future<Result<AuthResult>> register(String name, String email, String phone, String password, String role);
  Future<Result<AuthResult>> loginWithPassword(String email, String phone, String password);
  ...
  Future<Result<void>> resetPassword(String type, String phone, String email, String otp, String newPassword);
}
